...
const totalTimeWastedElement = document.getElementById("totalTimeWastedElement")
  ...
  entryTaskList.map((task, index) => {
    taskListRowsElement += `
      <tr>
        ...
        <td class="text-end">
          <button onclick="handleOnDelete('${task.id}')" class="btn btn-danger btn-sm">
            <i class="fa-trash fa-solid"></i>
          </button>
        
          <button onclick="switchTask('${task.id}')" class="btn btn-success btn-sm">
    ...
    taskListRowsElement += `
      <tr>
        ...
        <td class="text-end">
          ...
          <button onclick="switchTask('${task.id}')" class="btn btn-warning btn-sm">
